    	...
    	<div class="col-md-10 d-content">
    		<div class="row">
    			<div class="col text-start">
	                <p class="pro_tb">Add Product</p><br>
	            </div>
    		</div>
	    	<div class="row">
		      <form action="" id="productForm">
				...
				<div class="d-grid gap-2 d-md-flex justify-content-md-end but">
		          ...
		          <button type="submit" class="btn btn-addPro" onclick="add_product()">Add Product</button>
				</div>
    ...
    var databaseRef = firebase.database().ref('products/');
     ...
     // Check if the product ID already exists in the database
        firebase.database().ref('products/' + productId).once('value')
          .then((snapshot) => {
            if (snapshot.exists()) {
              alert("The Product Id is already in use. Please use another Id.");
            } else {
              var data = {
                productId: productId,
              ...
              // Update data in Firebase with the new product
              var updates = {};
