...
<html lang="en">
  ...
  <body onload="getdata()">
    	...
    	<div class="col-md-10 d-content">
	    	<div class="row">
	            <div class="col text-start">
	                <p class="pro_tb">Admin Information Table</p>
	            </div>
	            <div class="col text-end">
	                <button class="btn btn-readPro" onclick="addAdmin()">+ Add Admin</button>
	            </div>
	        </div>
	        <div class="card card-read mt-3">
	            <div class="card-body">
	        <!-- TABLE START -->
	                <table class="table table-hover table-responsive text-center" id="tb_users">
	                    <tr class="table-head">
	                    	<td>ID</td>
	                        <td>Name</td>
	                        <td>Email</td>
    ...
    <script>
	    ...
	    function getdata() {
	    	var tbUser = document.getElementById('tb_users');
		    ...
		    var rowIndex = 1;
	    	 ...
	    	 var row = tbUser.insertRow(rowIndex);
				...
				var cellAction = row.insertCell(4); //Tambahin action  untuk tempat button
            ...
            button.onclick = function() {
                ...
                window.location.href = 'update_admin.jsp?id=' + childKey;
            };
